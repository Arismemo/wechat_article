...
class Settings(BaseSettings):
    ...
    phase2_worker_heartbeat_key: str = Field(default="phase2:worker:heartbeat", alias="PHASE2_WORKER_HEARTBEAT_KEY")
    ...
    phase3_worker_heartbeat_key: str = Field(default="phase3:worker:heartbeat", alias="PHASE3_WORKER_HEARTBEAT_KEY")
    ...
    phase4_worker_heartbeat_key: str = Field(default="phase4:worker:heartbeat", alias="PHASE4_WORKER_HEARTBEAT_KEY")
    ...
    topics_search_per_query: int = Field(default=5, alias="TOPICS_SEARCH_PER_QUERY")
    topics_candidate_signal_limit: int = Field(default=200, alias="TOPICS_CANDIDATE_SIGNAL_LIMIT")
    topic_fetch_queue_key: str = Field(default="topics:fetch:queue", alias="TOPIC_FETCH_QUEUE_KEY")
    topic_fetch_processing_key: str = Field(default="topics:fetch:processing", alias="TOPIC_FETCH_PROCESSING_KEY")
    topic_fetch_pending_set_key: str = Field(default="topics:fetch:pending", alias="TOPIC_FETCH_PENDING_SET_KEY")
    topic_fetch_worker_poll_timeout_seconds: int = Field(default=5, alias="TOPIC_FETCH_WORKER_POLL_TIMEOUT_SECONDS")
    topic_fetch_worker_idle_sleep_seconds: int = Field(default=1, alias="TOPIC_FETCH_WORKER_IDLE_SLEEP_SECONDS")
    topic_fetch_worker_heartbeat_key: str = Field(default="topics:fetch:worker:heartbeat", alias="TOPIC_FETCH_WORKER_HEARTBEAT_KEY")
