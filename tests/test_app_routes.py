...
class AppRouteTests(unittest.TestCase):
    ...
    def test_internal_phase2_route_is_registered(self) -> None:
        ...
        self.assertIn("/api/v1/admin/topics/candidates/{candidate_id}/watch", routes)
        self.assertIn("/api/v1/admin/topics/candidates/{candidate_id}/ignore", routes)
        self.assertIn("/api/v1/admin/topics/candidates/{candidate_id}/plan", routes)
        ...
        self.assertIn("/admin/api/topics/candidates/{candidate_id}/watch", routes)
        self.assertIn("/admin/api/topics/candidates/{candidate_id}/ignore", routes)
        self.assertIn("/admin/api/topics/candidates/{candidate_id}/plan", routes)
        ...
        self.assertIn("/internal/v1/topics/candidates/{candidate_id}/watch", routes)
        self.assertIn("/internal/v1/topics/candidates/{candidate_id}/ignore", routes)
        self.assertIn("/internal/v1/topics/candidates/{candidate_id}/plan", routes)
    ...
    def test_admin_topics_page_renders(self) -> None:
        ...
        self.assertIn("data-candidate-status-action", response.text)
        self.assertIn("/admin/api/topics/candidates/", response.text)
        self.assert_admin_shell(response.text)
